...
librii::g3d::SrtFlags DrawSrtFlags(const librii::g3d::SrtFlags& flags) {
  ...
  result.Unknown = Checkbox("Unknown", flags.Unknown);
  result.Unknown = Checkbox("Identity Sclaing", flags.Unknown);
  result.Unknown = Checkbox("Identity Rotation", flags.Unknown);
  result.Unknown = Checkbox("Identity Translation", flags.Unknown);
  result.Unknown = Checkbox("Isotropic Sclaing", flags.Unknown);
...
DrawSrtOptions(const librii::g3d::SrtAnimationArchive& init) {
  ...
  ImGui::InputInt("Frame duration", &frame_duration);
  result.frame_duration = frame_duration;

  int xform_model = result.xform_model;
  ImGui::Combo("Transform model", &xform_model,
               "Maya\0"
               "XSI\0"
               "Max\0");
  ...
  result.anim_wrap_mode =
      imcxx::Combo("Temporal wrap mode", result.anim_wrap_mode,
                   "Clamp\0"
                   "Repeat\0");
...
struct G3dSrtOptionsSurface {
  static inline const char* name = "Options";
