...
struct Quantization
{
	...
	bool operator==(const Quantization& rhs) const {
		...
		return mComp.normal == rhs.mComp.normal && mType.generic == rhs.mType.generic && divisor == rhs.divisor && stride == rhs.stride;
	}
};
...
struct GenericBuffer {
	...
	bool operator==(const GenericBuffer& rhs) const {
		return mName == rhs.mName && mId == rhs.mId && mQuantize == rhs.mQuantize && mEntries == rhs.mEntries;
	}
};
class PositionBuffer : public GenericBuffer<glm::vec3, true, true, libcube::gx::VertexBufferKind::position>
{};
class NormalBuffer : public GenericBuffer<glm::vec3, false, true, libcube::gx::VertexBufferKind::normal>
{};
class ColorBuffer : public GenericBuffer<libcube::gx::Color, false, false, libcube::gx::VertexBufferKind::color>
{};
class TextureCoordinateBuffer : public GenericBuffer<glm::vec2, true, true, libcube::gx::VertexBufferKind::textureCoordinate>
{};
