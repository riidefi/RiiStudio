...
inline Result<librii::egg::LightSet> ReadBLIGHT(std::span<const u8> buf,
...
inline void WriteBLIGHT(const librii::egg::LightSet& b, std::string_view path) {
