...
#pragma region Basic Themes
	...
	static inline const char* ThemeNames = "Classic\0Dark\0Light\0Not Quite UE4\0Raikiri\0Adaptive\0Corporate Grey\0Zenith: Dark\0Zenith: Light\0";
	...
	template<>
	inline void setTheme<BasicTheme::CorporateGrey>() {
		ImGuiStyle& style = ImGui::GetStyle();
		ImVec4* colors = style.Colors;
